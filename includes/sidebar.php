...
<nav class="flex-1 mt-4 px-4 space-y-2">
    ...
    $navItems = [
        ...
        ['id' => 'bus_management', 'label' => 'จัดการรถ', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path>'],
